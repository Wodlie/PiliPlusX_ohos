...
class VideoDetailController extends GetxController
  ...
  int get currPosInMilliseconds =>
      defaultST?.inMilliseconds ?? plPlayerController.positionDuration.inMilliseconds;
  @override
      ...
      PublishRoute(
        pageBuilder: (buildContext, animation, secondaryAnimation) {
          return SendDanmakuPanel(
            cid: cid.value,
            bvid: bvid,
            progress: plPlayerController.positionDuration.inMilliseconds,
  ...
  void updatePlayer() {
    ...
    playedTime = plPlayerController.positionDuration;
    plPlayerController
    ...
    if (postList.isEmpty) {
      postList.add(
        PostSegmentModel(
          segment: Pair(
            first: 0,
            second: plPlayerController.positionDuration.inMilliseconds / 1000,
          ),
