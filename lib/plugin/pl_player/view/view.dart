...
class _PLVideoPlayerState extends State<PLVideoPlayer>
      ...
      final int newPos =
          (curSliderPosition +
                  (plPlayerController.sliderScale * delta.dx / maxWidth)
                      .round())
              .clamp(0, plPlayerController.durationInMilliseconds);
      final Duration result = Duration(milliseconds: newPos);
      final double height = maxHeight * 0.125;
  ...
  void _onInteractionEnd(ScaleEndDetails details) {
    ...
    if (plPlayerController.isSliderMoving) {
      if (plPlayerController.cancelSeek == true) {
        plPlayerController.onUpdatedSliderProgress(
          plPlayerController.positionDuration,
        );
      } else {
                ...
                child: Align(
                  ...
                  child: FractionalTranslation(
                    ...
                    child: Obx(
                      () => AnimatedOpacity(
                        curve: Curves.easeInOut,
                        opacity: plPlayerController.isSliderMoving
                            ? 1.0
                            : 0.0,
                        duration: const Duration(milliseconds: 150),
                        child: Container(
  ...
  late final segment = Pair(
    first: plPlayerController.positionDuration.inMilliseconds / 1000.0,
    second: plPlayerController.positionDuration.inMilliseconds / 1000.0,
  );
  ...
  Future<void> screenshotWebp() async {
    ...
    final currentPos = ctr.positionDuration.inMilliseconds / 1000.0;
    final duration = ctr.durationDuration.value.inMilliseconds / 1000.0;
