...
class CustomIcons {
  ...
  static const IconData identifier_circle = _CustomIconData(0xe819);
  static const IconData watch_later = _CustomIconData(0xe818);
  static const IconData history = _CustomIconData(0xe81a);
  static const IconData subscriptions_outlined = _CustomIconData(0xe81b);
  static const IconData watch_later_outlined = _CustomIconData(0xe81c);
}

// Using direct IconData instead of extending (IconData is final in Flutter 3.x)
typedef _CustomIconData = IconData;
